...
class isValidMoveQueen{
    ...
    void Test1(){
        ...
        Assertions.assertEquals(1, validator.isValidMove(board, new Move(0,7,4,3), null, Color.White));
    }
    ...
    void Test2(){
        ...
        AbstractValidator validator = new ValidatorStandart();
        board.setField(new Piece(PieceType.Queen, Color.White), 0, 7);
        Assertions.assertEquals(0, validator.isValidMove(board, new Move(0,7,4,3), null, Color.Black));
    }
    ...
    void Test3(){
        ...
        Assertions.assertEquals(0, validator.isValidMove(board, new Move(0,7,2,5), null, Color.White));
    }
    //kill enemy's piece
    @Test
    void Test4(){
        ...
        board.setField(new Piece(PieceType.Queen, Color.Black), 3, 4);
        board.printBoard();
        Assertions.assertEquals(2, validator.isValidMove(board, new Move(0,7,4,3), null, Color.White));
    }
    ...
    void Test8(){
        ...
        board.printBoard();
        Assertions.assertEquals(0, validator.isValidMove(board, new Move(0,7,4,3), null, Color.White));
    }
    ...
    void Test5(){
        ...
        board.printBoard();
        Assertions.assertEquals(0, validator.isValidMove(board, new Move(0,7,5,2), null, Color.White));
    }
    ...
    void Test6(){
        ...
        board.printBoard();
        Assertions.assertEquals(2, validator.isValidMove(board, new Move(4,3,2,5), null, Color.Black));
        validator.makeMove(board, new Move(4, 3,2, 5));
        Assertions.assertEquals(2, validator.isValidMove(board, new Move(2,5,0,3), new Move(4, 3,2, 5), Color.Black));
        validator.makeMove(board, new Move(2,5,0,3));
        Assertions.assertEquals(2, validator.isValidMove(board, new Move(0,3,2,1), new Move(2,5,0,3), Color.Black));
    }
    ...
    void Test7(){
        ...
        Assertions.assertEquals(2, validator.isValidMove(board, new Move(4,3,2,5), null, Color.Black));
        validator.makeMove(board, new Move(4, 3,2, 5));
        Assertions.assertEquals(0, validator.isValidMove(board, new Move(2,5,0,3), new Move(4, 3,2, 5), Color.Black));
        validator.makeMove(board, new Move(2,5,0,3));
        Assertions.assertEquals(2, validator.isValidMove(board, new Move(0,3,2,1), new Move(2,5,0,3), Color.Black));
    }
    ...
    void Test9(){
        ...
        Assertions.assertEquals(2, validator.isValidMove(board, new Move(0,7,2,5), null, Color.Black));
        validator.makeMove(board, new Move(0, 7,2, 5));
        Assertions.assertEquals(0, validator.isValidMove(board, new Move(2,5,1,4), new Move(0, 7,2, 5), Color.Black));
    }
}